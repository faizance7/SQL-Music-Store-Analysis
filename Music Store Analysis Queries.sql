...
-- 6) WRITE QUERY TO RETURN EMAIL,FIRST NAME, LAST NAME & GENRE OF ALL ROCK MUSIC LISTENER.
...
-- 7)LETS INVITE THE ARTIST WHO HAVE WRITTEN MOST ROCK MUSIC IN OUR DATASET.
...
-- 8) RETURN ALL THE TRACK NAME THAT HAVE SONG LENGTH LONGER THAN THE AVERAGE SONG LENGTH.
...
-- 9) FIND HOW MUCH AMOUNT SEPNT BY EACH CUSTOMER ON ARTIST?
...
-- 10) WE WANT TO FIND OUT THE MOST FAMOUS MUSIC GENRE FOR EACH COUNTRY. WE DETERMINE THE MOST FAMOUS GENRE AS THE GENRE WITH THE HIGHEST AMOUNT OF PURCHASES.
...
-- 11)write a query to determine the customer who spent most on music for each country.
